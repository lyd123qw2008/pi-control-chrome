...
```powershell
corepack pnpm --dir <DSH_HOME>/profiles/web add @lyd123qw2008/dsh-tool-control-chrome@0.5.6
```
...
{
  "dependencies": {
    "@lyd123qw2008/dsh-tool-control-chrome": "0.5.6"
  }
}
```
