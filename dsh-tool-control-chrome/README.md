...
```powershell
corepack pnpm --dir <DSH_HOME>/profiles/web add @lyd123qw2008/dsh-tool-control-chrome@0.4.3
```
...
{
  "dependencies": {
    "@lyd123qw2008/dsh-tool-control-chrome": "0.4.3"
  }
}
```
