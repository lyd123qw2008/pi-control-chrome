...
- Treat the Pi root package, browser extension Manifest, DSH package, and active DSH Profile as separate release surfaces.
...
Read the package manifests, lockfiles, `CHANGELOG.md`, and both publish workflows. Build this matrix before editing:
...
## Phase 3: update and verify active DSH Profile
